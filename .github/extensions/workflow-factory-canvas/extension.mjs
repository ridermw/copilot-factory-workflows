...
// Read-only directed workflow graph showing Agent Factory run progress
//
...
function renderHtml(instanceId) {
    return `<!doctype html>
<html>
  <head><meta charset="utf-8" /><title>workflow-factory-canvas</title></head>
  <body style="font-family: system-ui; padding: 1rem;">
    <h1>workflow-factory-canvas</h1>
...
const session = await joinSession({
    canvases: [
        createCanvas({
            ...
            displayName: "workflow-factory-canvas",
